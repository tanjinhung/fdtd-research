      ...
      for (nn = 0; nn < (grid->param.sizeY - 1); nn++) {
        for (pp = 0; pp < (grid->param.sizeZ - 1); pp++) {
          grid->hx[IDX3(mm, nn, pp, grid->param.sizeY - 1,
                        grid->param.sizeZ - 1)] =
              grid->chxh[IDX3(mm, nn, pp, grid->param.sizeY - 1,
                              grid->param.sizeZ - 1)] *
                  grid->hx[IDX3(mm, nn, pp, grid->param.sizeY - 1,
                                grid->param.sizeZ - 1)] +
              grid->chxe[IDX3(mm, nn, pp, grid->param.sizeY - 1,
                              grid->param.sizeZ - 1)] *
                  ((grid->ey[IDX3(mm, nn, pp + 1, grid->param.sizeY - 1,
                                  grid->param.sizeZ - 1)] -
                    grid->ey[IDX3(mm, nn, pp, grid->param.sizeY - 1,
                                  grid->param.sizeZ - 1)]) -
                   (grid->ez[IDX3(mm, nn + 1, pp, grid->param.sizeY - 1,
                                  grid->param.sizeZ - 1)] -
                    grid->ez[IDX3(mm, nn, pp, grid->param.sizeY - 1,
                                  grid->param.sizeZ - 1)]));
        }
      }
    }
        ...
        for (pp = 0; pp < (grid->param.sizeZ); pp++) {
          grid->hz[IDX3(mm, nn, pp, grid->param.sizeY - 1, grid->param.sizeZ)] =
              ...
              grid->chze[IDX3(mm, nn, pp, grid->param.sizeY - 1,
                              grid->param.sizeZ)] *
                  ((grid->ex[IDX3(mm, nn + 1, pp, grid->param.sizeY - 1,
                                  grid->param.sizeZ)] -
                    grid->ex[IDX3(mm, nn, pp, grid->param.sizeY - 1,
                                  grid->param.sizeZ)]) -
        ...
        for (pp = 1; pp < (grid->param.sizeZ - 1); pp++) {
          grid->ex[IDX3(mm, nn, pp, grid->param.sizeY, grid->param.sizeZ)] =
              ...
              grid->cexh[IDX3(mm, nn, pp, grid->param.sizeY,
                              grid->param.sizeZ)] *
                  ((grid->hz[IDX3(mm, nn, pp, grid->param.sizeY,
                                  grid->param.sizeZ)] -
                    grid->hz[IDX3(mm, nn - 1, pp, grid->param.sizeY,
                                  grid->param.sizeZ)]) -
                   (grid->hy[IDX3(mm, nn, pp, grid->param.sizeY,
                                  grid->param.sizeZ)] -
              ...
              grid->cezh[IDX3(mm, nn, pp, grid->param.sizeY,
                  ...
                  ((grid->hy[IDX3(mm, nn, pp, grid->param.sizeY,
                    ...
                    grid->hy[IDX3(mm - 1, nn, pp, grid->param.sizeY,
                                  grid->param.sizeZ - 1)]) -
                   (grid->hx[IDX3(mm, nn, pp, grid->param.sizeY,
                                  grid->param.sizeZ - 1)] -
                    grid->hx[IDX3(mm, nn - 1, pp, grid->param.sizeY,
                                  grid->param.sizeZ - 1)]));
        }
      }
    }
